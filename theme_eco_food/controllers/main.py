...
class WebsiteEcoFoodNewArrivals(http.Controller):
    ...
    def eco_food_new_arrivals(self):
        ...
        response = http.Response(template='theme_eco_food.eco_food_new_arrivals', qcontext=products)
    ...
    def get_best_seller(self):
        ...
        response = http.Response(template='theme_eco_food.eco_food_best_seller', qcontext=values)
        return response.render()
    ...
    def get_featured_products(self):
        ...
        response = http.Response(template='theme_eco_food.eco_food_featured_products', qcontext=values)
        return response.render()
